...
sun.transforms = iod.clean %>%
  ...
  theme_classic() +
  theme(text=element_text(size=12,  family="CM Sans")) +
  geom_line(aes(y = sun.step.preds), colour = "red", size = 1.5) +
  geom_line(aes(y = sun.poly.preds), colour = "green", size = 1.5) +
  geom_line(aes(y = sun.spline.preds), colour = "yellow", size = 1.5) 
...
scr.transforms = iod.clean %>%
  ...
  theme_classic() +
  theme(text=element_text(size=12,  family="CM Sans")) +
  geom_line(aes(y = scr.step.preds), colour = "red", size = 1.5) +
  geom_line(aes(y = scr.poly.preds), colour = "green", size = 1.5) +
  geom_line(aes(y = scr.spline.preds), colour = "yellow", size = 1.5) 
...
grid.arrange(sun.transforms, scr.transforms,
             age.transforms, cys.transforms,
             bmi.transforms, 
             nrow = 3)
